        ...
        <>
            <div className="w-1/2 mx-auto rounded-lg shadow-lg p-8">
                ...
                <div className="mt-4">
                    ...
                    <input 
                            type="text" id="nim" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                ...
                <div className="mt-4">
                    ...
                    <input 
                            type="text" id="nama" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline"
                            placeholder="ex: Ceceee"
                            value={nama}
                ...
                <div className="mt-4">
                    ...
                    <input 
                            type="text" id="angkatan" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline"
                            placeholder="ex: 2022"
                            value={angkatan}
                ...
                <div className="mt-4">
                    <label htmlFor="progam-studi" className="block text-gray-700 font-bold mb-2">
                        Program Studi :
                    </label>
                    <select 
                            id="program-studi" 
